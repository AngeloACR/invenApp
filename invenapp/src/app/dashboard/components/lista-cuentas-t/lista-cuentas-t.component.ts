...
@Component({
  ...
  templateUrl: "./lista-cuentas-t.component.html",
  styleUrls: ["./lista-cuentas-t.component.scss"]
})
export class ListaCuentasTComponent implements OnInit {
  faEye = faEye;
  faTrash = faTrashAlt;
  faPdf = faFilePdf;
  faEdit = faEdit;
  ...
  ngOnInit() {
    ...
    auxValues.forEach(value => {
      let aux = [value._id, value.name, value.clasificacion, value.naturaleza];
