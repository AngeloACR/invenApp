...
export class FormAlmacenComponent implements OnInit {
  ...
  catchUserErrors(){
    let aux1 = this.fAlmacen.code.errors ? this.fAlmacen.code.errors.required : false;
    let aux2 = this.fAlmacen.state.errors ? this.fAlmacen.state.errors.required : false;
    let aux3 = this.fAlmacen.address.errors ? this.fAlmacen.address.errors.required : false;
    let aux4 = this.fAlmacen.city.errors ? this.fAlmacen.city.errors.required : false;
