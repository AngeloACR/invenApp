...
export class ListaCompraComponent implements OnInit {
  ...
  getDocumentDefinition(i) {
    ...
    let compras = this.dbHandler.getLocal("comprasValues");
    ...
    let observaciones = compra.observaciones;
    let productosIngresados = compra.productosIngresados;

    let fieldsA = ["Almacen", "Estatus", "Referencia"];
    let almacenId = compra.almacen;
    let almacenCode;
    ...
    let valuesA = [[almacenCode, compra.estado, compra.referencia]];
